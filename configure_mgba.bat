...
"C:\PassionProjects\GBAEmu\PokemonQuetzal\vcpkg\downloads\tools\cmake-3.31.10-windows\cmake-3.31.10-windows-x86_64\bin\cmake.exe" .. -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE=C:\PassionProjects\GBAEmu\PokemonQuetzal\vcpkg\scripts\buildsystems\vcpkg.cmake -DVCPKG_TARGET_TRIPLET=x64-windows -G "Ninja" -DCMAKE_MAKE_PROGRAM="C:\PassionProjects\GBAEmu\PokemonQuetzal\vcpkg\downloads\tools\ninja-1.13.2-windows\ninja.exe"
